...
func parseSnapshotExpiryDate(expiry string) (time.Time, bool) {
	...
	layouts := []string{
		"02-Jan-06",   // 25-AUG-26
		"02-JAN-06",   // 25-AUG-26 uppercase
		"02Jan06",     // 25AUG26
		"02JAN06",     // 25AUG26 uppercase
		"02-Jan-2006", // 25-AUG-2026
		"02-JAN-2006", // 25-AUG-2026 uppercase
		"02Jan2006",   // 25AUG2026
		"02JAN2006",   // 25AUG2026 uppercase
		"2006-01-02",  // 2026-08-25
		"20060102",    // 20260825
	}
	...
	for _, layout := range layouts {
		...
		// Also try uppercase month variant if needed
